        ...
        {credenciales ? (
          ...
          <>
            ...
            <div className="space-y-4">
              <Input label="Nombre del local" icon={<Building2 size={16} />} value={nombre} onChange={e => setNombre(e.target.value)} placeholder="Sala Torneum" />
