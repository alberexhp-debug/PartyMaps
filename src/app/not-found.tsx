...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-[#0D0D1A] flex flex-col items-center justify-center px-6 text-center">
      <div className="w-20 h-20 bg-[#1A1A2E] rounded-3xl flex items-center justify-center mb-6">
        <Map size={36} className="text-[#505065]" />
      </div>
      ...
      <p className="text-sm text-[#505065] mb-8 max-w-xs">
