  ...
  try {
    ...
    if (evento_id) {
      ...
      if (evento && evento.estado === 'publicado') {
        // Cupo del evento: nunca por encima del aforo que el local puso a la venta en Tourneum (§6.2).
      ...
      // Cupo de la noche en Tourneum: nunca por encima de lo que el local pone a la venta aquí (§6.2).
