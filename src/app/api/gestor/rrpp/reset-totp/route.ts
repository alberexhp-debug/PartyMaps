...
import { resetTotpRrpp, rrppVinculadoALocal } from '@/lib/rrpp/crear'

/** POST /api/gestor/rrpp/reset-totp { local_id, rrpp_id } — reinicia el
 * authenticator de un RRPP vinculado a un local de la cartera del gestor. */
export async function POST(req: NextRequest) {
  ...
  const res = await resetTotpRrpp(svc, rrpp_id)
