...
import { MapPin, Mail, Lock, ChevronLeft, ChevronRight, Check, Store } from '@/components/todh/iconosTorneum'
...
export default function LocalPanelRegistroPage() {
  ...
  const registrar = async () => {
    ...
    // `pendiente_verificacion` → solicitud en el panel de admin de Torneum.
    try {
      ...
      <div className="min-h-screen flex flex-col items-center justify-center px-6 text-center gap-6">
        ...
        <div>
          ...
          <p className="text-[#A0A0B8] max-w-xs">
            Tu local está pendiente de verificación. El equipo de Torneum revisará la información y activará tu cuenta en 24-48h.
          </p>
        </div>
        <div className="glass rounded-2xl p-4 text-sm text-[#A0A0B8] text-left w-full max-w-xs space-y-1">
          ...
          <p>2. El equipo de Torneum revisa y aprueba tu local</p>
