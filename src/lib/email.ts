...
const FROM = process.env.RESEND_FROM || 'Tourneum <noreply@partymaps.es>'
...
/** Layout HTML común — header/footer Tourneum. Mantener inline-style por compatibilidad email. */
      ...
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background:#171C27;border-radius:24px;overflow:hidden;border:1px solid rgba(255,255,255,0.06);">
        <tr><td style="padding:28px 28px 0 28px;">
          <table role="presentation" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td style="padding-left:12px;color:#FAFAFC;font-weight:700;letter-spacing:0.16em;text-transform:uppercase;font-size:13px;">Tourneum</td>
            </tr>
          </table>
        </td></tr>
        ...
        <tr><td style="padding:0 28px 28px 28px;border-top:1px solid rgba(255,255,255,0.06);">
          <p style="margin:18px 0 0 0;color:#6B6B85;font-size:11px;line-height:1.5;">
            Recibes este email porque tienes una cuenta en Tourneum.<br />
