  ...
  return (
    ...
    >
      ...
      <div className="mt-8 flex flex-col items-center gap-2">
        <p className="text-2xl font-bold text-white text-display tracking-tight">PartyMaps</p>
        <p className="text-[10px] uppercase tracking-[0.4em] text-[#A0A0B8] font-bold">Ocio nocturno · Madrid</p>
      </div>
    </div>
  )
}
